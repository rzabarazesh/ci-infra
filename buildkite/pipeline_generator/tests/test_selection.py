...
class TestChangedTests:
    ...
    def test_are_only_tests_changed_true(self):
        ...
        file_diff = ["tests/v1/test_engine.py", "tests/v2/test_model.py"]
    ...
    def test_are_only_tests_changed_false(self):
        ...
        file_diff = ["tests/v1/test_engine.py", "vllm/engine.py"]
...
class TestIntelligentTestTargeting:
    ...
    def test_get_intelligent_test_targets_no_dependencies(self):
        ...
        test_step = TestStep(label="Test", commands=["pytest v1/"])
...
class TestShouldBlockStep:
    ...
    def test_torch_nightly_group_blocking(self):
        ...
        # In torch nightly group with dependencies but no matches, should be
        # blocked
        assert should_block_torch_nightly_test(test_step, Config()) is True
    ...
    def test_torch_nightly_group_not_blocking_in_nightly_mode(self):
        ...
        assert should_block_torch_nightly_test(test_step, Config()) is False
